...
function estudiantesNecesitanTutoria($lista) {
    return array_filter($lista, fn($e) => $e["promedio"] < 75);
}

// 9. Función para listar estudiantes de honor (promedio >= 90)
function estudiantesHonor($lista) {
    return array_filter($lista, fn($e) => $e["promedio"] >= 90);
}
