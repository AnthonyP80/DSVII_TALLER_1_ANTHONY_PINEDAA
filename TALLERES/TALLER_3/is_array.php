...
$miArray = ["Panamá", "Brasil", "España", "Nueva Zelanda"]; // Reemplaza esto con tu propio array
$miString = "Anthony Sebastian Pineda Gonzalez"; // Reemplaza esto con tu propio string
$miNumero = ["78"]; // Reemplaza esto con tu propio número
