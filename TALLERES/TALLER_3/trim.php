...
$textoConEspacios = "Hola, me llamo Anthony_Pineda, tengo varios proyectos en marcha:
Desarrollo de software en Java, PHP, y React.
Administración de servidores (Linux, Plesk, WHM).
Estudios universitarios (Contabilidad, Investigación de Operaciones, etc.).
Además, me gusta organizar mis tareas de la siguiente manera:
Programar por la mañana,
Estudiar por la tarde,
Revisar pendientes al final del día.
En resumen: trabajo_estudio_proyectos, todo junto... paso_a_paso.";
...
$textoConCaracteres = "Hola, me llamo Anthony_Pineda, tengo varios proyectos en marcha:
Desarrollo de software en Java, PHP, y React.
Administración de servidores (Linux, Plesk, WHM).
Estudios universitarios (Contabilidad, Investigación de Operaciones, etc.).
Además, me gusta organizar mis tareas de la siguiente manera:
...
$textoParaLimpiar = "___   Mi nombre es Anthony   ___";
