...
$misComidas = ["arroz con pollo", "lazaña", "pasta"]; // Reemplaza con tus comidas favoritas
$comidasAmigo = ["lentejas", "caviar", "pescado frito con limon"]; // Reemplaza con las comidas favoritas de tu amigo
